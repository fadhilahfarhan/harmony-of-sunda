        ...
        <Row>
          <Col md={6} className='my-auto p-4'>
            ...
            <p style={{fontWeight: '200', color: 'grey', textAlign: 'left'}}>
              ...
              Ini adalah platform yang tidak hanya mendidik tetapi juga menumbuhkan apresiasi terhadap keberagaman 
              dan keindahan peninggalan Sunda.
              Melalui “Harmony of Sunda”, individu dari berbagai lapisan masyarakat dapat memperoleh 
              pemahaman yang lebih mendalam tentang permadani budaya yang membentuk identitas Sunda.
            </p>
          </Col>
